...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        $c_sql = "Insert into paciente (nome,fone1,fone2,endereco,bairro, cep,email) Value ('$c_nome', '$c_fone1', '$c_fone2', 
        '$c_endereco', '$c_bairro', '$c_cep',  '$c_email')";
        ...
        header('location: /transporte/cadastros/pacientes/pacientes_lista.php');
    } while (false);
}
        ...
        <div style="padding-top:5px;">
            <div class="panel panel-primary class">
                ...
                <div class="panel-heading text-center">
                    ...
                    <h5>Entrada de Novo Paciente<h5>
                </div>
            </div>
        </div>
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                <div class="offset-sm-0 col-sm-3">
                    ...
                    <a class='btn btn-danger' href='/transporte/cadastros/pacientes/pacientes_lista.php'><span class='glyphicon glyphicon-remove'></span> Cancelar</a>
                </div>
