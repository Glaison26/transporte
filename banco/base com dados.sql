...
-- Copiando dados para a tabela transporte.lancamentos: ~3 rows (aproximadamente)
INSERT INTO `lancamentos` (`id`, `id_solicitante`, `id_paciente`, `id_motorista`, `id_veiculo`, `data`, `hora`, `destino`, `justificativa`, `tipo`) VALUES
	...
	(5, 1, 1, 3, 8, '2025-01-30', '22:04:00', 'Deslocamento de Profissional para UPA', _binary 0x7465737465, 'Oncologia');
...
-- Copiando dados para a tabela transporte.solicitantes: ~2 rows (aproximadamente)
...
INSERT INTO `usuarios` (`id`, `nome`, `login`, `senha`, `cadastro`, `consulta`, `tipo`, `ativo`, `lancamentos`) VALUES
	...
	(3, 'Prefeitura de Sabará', 'prefeitura', 'UHJlZmVpdHVyYUAyMDI1', 'N', 'N', 'Operador', 'S', 'N');
