...
-- Copiando dados para a tabela transporte.paciente: ~10 rows (aproximadamente)
...
-- Copiando dados para a tabela transporte.solicitantes: ~22 rows (aproximadamente)
...
-- Copiando dados para a tabela transporte.usuarios: ~5 rows (aproximadamente)
...
-- Copiando dados para a tabela transporte.veiculo: ~25 rows (aproximadamente)
