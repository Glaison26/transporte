...
CREATE TABLE IF NOT EXISTS `lancamentos` (
  ...
  `justificativa` blob,
  `tipo` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Copiando dados para a tabela transporte.motoristas: ~5 rows (aproximadamente)
INSERT INTO `motoristas` (`id`, `nome`, `endereco`, `bairro`, `cep`, `cnh`, `fone1`, `fone2`, `email`) VALUES
	(6, 'Anisio Henrique Vieira', 'Av Longitudinal  326', 'Vila Sto Antonio', '34515-440', '02765071500', '(31) 99856-2683', '', ''),
	...
	(12, 'RONALDO COELHO DE SOUZA', 'RUA DAS LARANJEIRAS, 46', 'CENTRO', '', '02131565399', '(31) 98723-9349', '', ''),
	(13, 'RENATO ANTONIO DOS SANTOS', 'RUA BEIRA RIO, 327', 'AGUAS FÉRREAS', '', '01473973460', '(31) 98603-4341', '', '');
...
INSERT INTO `paciente` (`id`, `nome`, `fone1`, `fone2`, `endereco`, `bairro`, `cep`, `email`) VALUES
	...
	(2, 'Marinho Soares', '(31) 99347-6273', '', 'Rua Pirapora, 678', 'N. Sra de Fátima', '', ''),
	...
	(11, 'ALEXANDRA CANDIDA', '(31) 99803-1213', '', 'RUA JOÃO HAMACEK, 28', 'BANDEIRANTES', '', '');
...
INSERT INTO `solicitantes` (`id`, `nome`, `telefone`, `setor`, `telefone2`) VALUES
	...
	(23, 'UPA - PADRE LÁZARO', '(31) 3671-9850', 'UNIDADE PRONTO ATENDIMENTO', ''),
	(24, 'CENTRAL', '(31) 3671-5225', '', '');
